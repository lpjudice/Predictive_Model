## nesse tem Top 7 KPIs, All KPIs, Top Down Analysis, Individual Store: 7 KPIs, Individual Store: All KPIs e o cross validation no menu

## all stores e 
#       individual stores para 7 kpis, 
#       all kpis e top down (all kpis). 
#       top down para all stores e individual
#       Também inclui debug e um detalhe do dataset

## esse código ANTERIOR (sem o Year) foi pro ar no Stremlit no link https://predictivemodel-9bpcejokymap7ekzuzkkep.streamlit.app/

## ADICIONADO A COLUNA Year E ESTÁ TUDO FUNCIONANDO, EM 12 OUT.. AINDA NÃO FOI PARA LIVE
### ADICIONADA A CORRELACAO TOTAL E POR LOJA COMO MENUS INDIVIDUAIS.

### 17:22am de 13/Oct/24
### adicionei o limite a 100% de cada dependent variable
### time-series funcionando com 2 modelos, linear regression e exponential smoothing. 
#### esse arquivo está SEM o "Past Predictions" que guarda um link do google drive com o arquivo enviado
#### está mais fácil de usar, caso o do google drive nao funcione

## in the working.py, estou adicionando a integração com o google drive para guardar os links dos arquivos enviados

### AINDA FALTA VALIDAR ALTERAÇÕES EM PLANILHAS.. TESTAR OUTRAS VÁRIAS PARA VALIDAR O MODELO
...
st.markdown("""
    ...
    .sidebar .sidebar-content .sidebar-menu .stRadio > div {
        ...
        cursor: pointer;
        transition: background-color 0.3s ease;
        font-size: 12px !important; /* Adjusted font size for better readability */
    }
...
# Model Performance Comparison (to be called in Part 2)
...
# Main code and remaining functions (Part 2)
def main():
    ...
    page = st.sidebar.radio("", [
        ...
        "All Stores: Category Impact",  # Renamed
        ...
        "Individual Store: Category Impact",  # Renamed
        # Other Menus
        "Cross-Validation",
        "Diagnostic Information",
        "Time-Series"  # New Menu Item Added Here
    ])
    ...
    if uploaded_file is not None:
        ...
        if pd.isnull(cell_value):
            ...
            elif page == "Time-Series":  # New Menu Handling
                display_time_series_analysis(df.copy(), targets, indicator_mapping)
                # Removed Model Performance Comparison from Time-Series page
